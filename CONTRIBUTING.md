...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("openair-project/openairmaps", fork = TRUE)`.
...
[openairmaps](https://openair-project.github.io/openairmaps/) project is
released with a [Contributor Code of
Conduct](https://openair-project.github.io/openairmaps/CODE_OF_CONDUCT.md).
